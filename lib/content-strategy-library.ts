...
export const defaultContentStrategyLibrary: ContentStrategyLibraryItem[] = [
  {
    ...
    imageUrl: '/assets/content-strategies/photos/lifestyle-content.jpg',
  ...
  },
  {
    ...
    purpose: '推動受眾即時行動。',
    imageUrl: '/assets/content-strategies/photos/offer-promotion.jpg',
  ...
  },
  {
    ...
    imageUrl: '/assets/content-strategies/photos/product-education.jpg',
  ...
  },
  {
    ...
    imageUrl: '/assets/content-strategies/photos/problem-solution.jpg',
  ...
  },
  {
    ...
    imageUrl: '/assets/content-strategies/photos/entertainment-content.jpg',
  ...
  },
  {
    ...
    purpose: '建立信任與影響力。',
    imageUrl: '/assets/content-strategies/photos/authority-content.jpg',
  ...
  },
  {
    ...
    imageUrl: '/assets/content-strategies/photos/opinion-hot-take.jpg',
  ...
  },
  {
    ...
    purpose: '建立情感連結。',
    imageUrl: '/assets/content-strategies/photos/storytelling.jpg',
  ...
  },
  {
    ...
    purpose: '增加真實感與親切感。',
    imageUrl: '/assets/content-strategies/photos/behind-the-scenes.jpg',
  ...
  },
  {
    ...
    purpose: '降低信任成本。',
    imageUrl: '/assets/content-strategies/photos/social-proof.jpg',
  ...
  },
  {
    ...
    imageUrl: '/assets/content-strategies/photos/community-content.jpg',
    examples: ['問問題', '投票', '回留言'],
    funnelStage: 'top',
  ...
  },
  {
    ...
    purpose: '快速曝光。',
    imageUrl: '/assets/content-strategies/photos/trend-hijacking.jpg',
  ...
  },
  {
    ...
    imageUrl: '/assets/content-strategies/photos/personal-brand-content.jpg',
  ...
  },
  {
    ...
    purpose: '推動轉化與下一步行動。',
    imageUrl: '/assets/content-strategies/photos/call-to-action-content.jpg',
  ...
  },
  {
    ...
    purpose: '製造高吸引力與認知反差。',
    imageUrl: '/assets/content-strategies/photos/contrarian-content.jpg',
  ...
  },
  {
    ...
    imageUrl: '/assets/content-strategies/photos/series-content.jpg',
...
function imageForStrategy(id: string) {
  ...
  return item?.imageUrl || '/assets/content-strategies/photos/lifestyle-content.jpg'
}
